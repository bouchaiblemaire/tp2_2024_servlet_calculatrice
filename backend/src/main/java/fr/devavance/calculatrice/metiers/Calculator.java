...
public class Calculator {
    ...
    public static double soustraction(String s_operande_1, String s_operande_2) 
            throws NumberFormatException {
<<<<<<< HEAD:backend/src/main/java/fr/devavance/calculatrice/metiers/Calculator.java
        int operande_1 = Integer.parseInt(s_operande_1);        
        int operande_2 = Integer.parseInt(s_operande_2);
=======
>>>>>>> ed212755453492682d2a0ae9ed6f9ba290baac25:src/main/java/fr/devavance/calculatrice/Calculator.java
